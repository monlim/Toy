...
const Cough3 = new Tone.Player(
  "https://monlim.github.io/AccelTrial/Audio/Cough3.mp3"
).toDestination();
const Cough4 = new Tone.Player(
  "https://monlim.github.io/AccelTrial/Audio/Cough4.mp3"
).toDestination();
const Cough5 = new Tone.Player(
  "https://monlim.github.io/AccelTrial/Audio/Cough5.mp3"
).toDestination();
...
const Ring3 = new Tone.Player(
  "https://monlim.github.io/AccelTrial/Audio/RingSsh.mp3"
).toDestination();
const Ring4 = new Tone.Player(
  "https://monlim.github.io/AccelTrial/Audio/Ring4.mp3"
).toDestination();
